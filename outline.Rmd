...
Play around with creating and customizing prettier plots in R, starting with the data.frames you worked with yesterday. Play with all the settings we demo'd: colors, point and line types, point sizes and line widths, margin sizes, multipanel plots, and saving options. 

To go above and beyond, try finding some new plot types or plotting arguments in `par` and see if you can incorporate them! Remember, google is your friend! 
