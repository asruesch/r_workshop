...
stations = aggregate(data$Date, by=list(data$StationID,data$StationName), FUN=length)
...
```{r,eval=FALSE}
pdf("C:/DNR/WQ/DeadPike/Vilas_County_Secchi_1995-2017_plots.pdf", width=8.5, height=11)
...
for (s in 1:nrow(stations)) {
  ...
  plot(Secchi~Date, sdata, type="n", 
       ...
       main=paste(stations$ID[s]," - ",stations$NAME[s], sep=""), cex.main=0.9)
