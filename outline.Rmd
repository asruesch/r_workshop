...
```{r fig.width=8, fig.height=4,tidy=TRUE,warning=FALSE}
library(leaflet)
leaflet() %>%
  addProviderTiles("Esri.WorldPhysical",
                   options=providerTileOptions(maxZoom=20))
#note - my version of leaflet runs into an error when zooming in:
#https://github.com/PaulLeCam/react-leaflet/issues/296
#might work with diff version or workaround
```
